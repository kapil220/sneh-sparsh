        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <Link href="/" className="inline-block mb-6">
              <div className="flex items-center">
                ...
                <span className="text-xl font-bold">Wanderlust Travels</span>
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/packages" className="text-gray-400 hover:text-white transition duration-300">Travel Packages</Link>
              </li>
              <li>
                <Link href="/#taxi-services" className="text-gray-400 hover:text-white transition duration-300">Taxi Services</Link>
              </li>
              <li>
                <Link href="/#about" className="text-gray-400 hover:text-white transition duration-300">About Us</Link>
              </li>
              <li>
                <Link href="/#testimonials" className="text-gray-400 hover:text-white transition duration-300">Testimonials</Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-white transition duration-300">Contact</Link>
              </li>
              <li>
                <Link href="/blog" className="text-gray-400 hover:text-white transition duration-300">Travel Blog</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  <p className="text-gray-400">123 Adventure Road</p>
                  <p className="text-gray-400">Travelville, CA 94123</p>
                </div>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@wanderlust-travels.com</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
